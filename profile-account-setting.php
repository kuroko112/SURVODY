								...
								<div class="tab-pane fade show active" id="nav-acc" role="tabpanel" aria-labelledby="nav-acc-tab">
							  	...
							  	<div class="tab-pane fade" id="privcy" role="tabpanel" aria-labelledby="nav-privcy-tab">
							  		<div class="acc-setting">
										...
										"   SELECT * FROM `friend` 
											LEFT JOIN users 
											ON users.user_id = friend.id_user_from 
											LEFT JOIN image_users 
											ON users.user_id = image_users.id_user_img
											WHERE accept = 0 AND friend.id_user_to = $user_id
										";
										// echo $accept;
										$result = mysqli_query($conn, $accept);
							  			...
							  			<div class="requests-list">
											<?php while($row = mysqli_fetch_assoc($result)) {?>
												...
												<div class="request-details">
													<div class="noty-user-img">
														<img src="server/upload/image/<?php echo $row['image_name']?>" alt="">
													</div>
