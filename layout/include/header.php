<header>
			<div class="container">
				<div class="header-data">
					<div class="logo">
						<a href="index.html" title=""><img src="images/usd.png" alt=""></a>
					</div><!--logo end-->
					...
					<div class="user-account">
						<div class="user-info">
							<img width="30px" src="server/upload/image/<?php echo $image_name?>" alt="">
							<a href="#" title=""><?php echo $_SESSION['user_data']['username'][0]?></a>
